...
const SESSION_CLEANUP_INTERVAL_MS = Number(process.env.SESSION_CLEANUP_INTERVAL_MS) || 10 * 1000;
...
const ORPHAN_GRACE_MS = Number(process.env.ORPHAN_GRACE_MS) || 2000;
...
const CLIENT_LIST_INCLUDE_UNRECOGNIZED = parseBoolean(process.env.CLIENT_LIST_INCLUDE_UNRECOGNIZED, true);
...
const JOBS_LIST_ALLOW_LEGACY_CLIENT_FILTER = parseBoolean(
  process.env.JOBS_LIST_ALLOW_LEGACY_CLIENT_FILTER,
  false
);

const TURNSTILE_ENABLED = parseBoolean(process.env.TURNSTILE_ENABLED, false);
const TURNSTILE_SITE_KEY = process.env.TURNSTILE_SITE_KEY || "";
const TURNSTILE_SECRET_KEY = process.env.TURNSTILE_SECRET_KEY || "";
const TURNSTILE_VERIFY_URL = process.env.TURNSTILE_VERIFY_URL
  || "https://challenges.cloudflare.com/turnstile/v0/siteverify";
const TURNSTILE_ALLOWED_HOSTNAMES = parseCsvList(process.env.TURNSTILE_ALLOWED_HOSTNAMES, []);
